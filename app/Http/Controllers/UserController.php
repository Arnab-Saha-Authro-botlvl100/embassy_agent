    ...
    public function passenger(Request $request)
    {
        if ($request->isMethod('POST')) {
            ...
            if($validatedData){
                ...
                if ($passenger->save()) {
                    // Success message
                    return redirect()->route('user/index')->with('success', 'Passenger has been added successfully.');
                } else {
                    // Error message
                    return redirect()->route('user/index')->with('error', 'Failed to add the passenger.');
                }
            }
    ...
    public function company(Request $request){
        ...
        if ($request->isMethod('POST')) {
            ...
            if($validatedData){
                ...
                if ($company->save()) {
                    // Success message
                    return redirect()->route('user/index')->with('success', 'Company has been added successfully.');
                } else {
                    // Error message
                    return redirect()->route('user/index')->with('error', 'Failed to add the company.');
                }
            }
            else{
    ...
    public function visa(Request $request){
        if ($request->isMethod('POST')) {
            ...
            if($validatedData){
                ...
                if ($visa->save()) {
                    // Success message
                    return redirect()->route('user/index')->with('success', 'Visa has been added successfully.');
                } else {
                    // Error message
                    return redirect()->route('user/index')->with('error', 'Failed to add the company.');
                }
